...
def uniform(*args):
	...
	with tf.io.gfile.GFile(os.path.join(curr_path,'uniform_final','frozen_inference_graph.pb'), 'rb') as f:
	...
	with tf.compat.v1.Session() as sess:
		...
		if(len(b)==0):
			...
			for k in b:
				...
				unif_output=','.join([class_names[k-1],])
	...
	return("missing : "+unif_output)

if __name__ == '__main__':
	print(uniform('unnamed.jpg'))